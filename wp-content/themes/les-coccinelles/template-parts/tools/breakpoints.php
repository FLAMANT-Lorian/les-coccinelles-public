<div class="fixed top-10 left-0 w-fit flex justify-between p-2 z-[999]">
    ...
    <div class="bg-pink-500 text-white px-4 py-2 hidden lg:block xg:hidden">LG</div>
    <div class="bg-indigo-800 text-white px-4 py-2 hidden xg:block xl:hidden">XG</div>
